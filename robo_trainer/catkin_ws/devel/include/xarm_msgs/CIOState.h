...
struct MD5Sum< ::xarm_msgs::CIOState_<ContainerAllocator> >
{
  ...
  {
    return "a7f214689509694603beffea47eac839";
  }

  static const char* value(const ::xarm_msgs::CIOState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa7f2146895096946ULL;
  static const uint64_t static_value2 = 0x03beffea47eac839ULL;
};
...
struct Definition< ::xarm_msgs::CIOState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# contorller gpio module state\n"
"int16 state\n"
"\n"
