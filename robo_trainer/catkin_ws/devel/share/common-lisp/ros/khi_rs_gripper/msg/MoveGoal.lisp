...
(cl:defmethod cl:initialize-instance :after ((m <MoveGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name khi_rs_gripper-msg:<MoveGoal> is deprecated: use khi_rs_gripper-msg:MoveGoal instead.")))

(cl:ensure-generic-function 'target_pulse-val :lambda-list '(m))
(cl:defmethod target_pulse-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader khi_rs_gripper-msg:target_pulse-val is deprecated.  Use khi_rs_gripper-msg:target_pulse instead.")
  (target_pulse m))

(cl:ensure-generic-function 'pulse_speed-val :lambda-list '(m))
(cl:defmethod pulse_speed-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader khi_rs_gripper-msg:pulse_speed-val is deprecated.  Use khi_rs_gripper-msg:pulse_speed instead.")
  (pulse_speed m))
