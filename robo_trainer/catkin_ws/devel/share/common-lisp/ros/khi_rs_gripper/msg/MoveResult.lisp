...
(cl:defmethod cl:initialize-instance :after ((m <MoveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name khi_rs_gripper-msg:<MoveResult> is deprecated: use khi_rs_gripper-msg:MoveResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader khi_rs_gripper-msg:success-val is deprecated.  Use khi_rs_gripper-msg:success instead.")
  (success m))

(cl:ensure-generic-function 'err_code-val :lambda-list '(m))
(cl:defmethod err_code-val ((m <MoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader khi_rs_gripper-msg:err_code-val is deprecated.  Use khi_rs_gripper-msg:err_code instead.")
  (err_code m))
